                ...
                <form role="form" method="post" action="{{url('admin/classes-create')}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('classID')}}" name="classID" class="form-control" placeholder="Input Class ID..." required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('className')}}" name="className" class="form-control" placeholder="Input Class Name..." required>
                        </div>
                        <div class="form-group">
                            <label>Class Room <span style="color: red">*</span></label>
                            <input type="text" value="{{old('classRoom')}}" name="classRoom" class="form-control" placeholder="Input Class Room..." required>
                        </div>
